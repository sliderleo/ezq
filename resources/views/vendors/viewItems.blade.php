...
<body>
    <div class="rounded-lg shadow bg-base-200 drawer drawer-mobile">
        ...
        <a href="{{ route('vendor.itemsV')}}"><h1 class="font-medium text-xl banner-text">&nbsp;All Items</h1></a>  
        <form method="post" action="{{url('/vendor/item-search')}}" enctype="multipart/form-data" role="search">
            @csrf
            <div class="relative">
