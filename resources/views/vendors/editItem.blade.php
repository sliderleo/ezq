...
<body>
    <div class="rounded-lg shadow bg-base-200  drawer drawer-mobile">
        ...
        <div class="flex flex-col drawer-con drawer-content">
            ...
            <h1 class="font-medium text-xl banner-text">&nbsp;Edit Item</h1> 
            <div class="container mx-auto">
                @foreach ($items as $item)
                <form method="post" action="/vendor/item-i-update/{{$item->id}}" enctype="multipart/form-data">
                    @csrf
                    <div class="grid grid-flow-col  gap-9 justify-items-center">
                        <div class="form-control">
                            ...
                            <input type="text" placeholder="Name" id="name" name="name" class="input" value="{{$item->name}}" minlength="4" maxlength="30" required>
                        </div>
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" placeholder="Price" id="price" name="price" class="input" value="{{$item->price}}" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-flow-col  gap-12 justify-items-center">
                        <div class="form-control">
                            ...
                            <textarea class="textarea h-24 textarea-bordered"  placeholder="Desc goes here" id="desc" name="desc" minlength="1" maxlength="50" required>{{$item->desc}}</textarea>
                        </div>
                        ...
                        <div class="form-control">
                            ...
                            <input type="text" placeholder="Barcode" id="barcode" name="barcode" class="input" minlength="5" value="{{$item->barcode}}" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-flow-col  justify-items-center">
                        <div class="form-control ">
                            ...
                            <select name="c_id" id="_id" class="select select-bordered select-secondary  w-full max-w-xs">
