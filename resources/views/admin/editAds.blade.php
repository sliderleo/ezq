...
<body>
    <div class="rounded-lg shadow bg-base-200  drawer drawer-mobile">
        ...
        <div class="flex flex-col drawer-con drawer-content">
            ...
            <h1 class="font-medium text-xl banner-text">&nbsp;Edit Ads</h1> 
            <div class="container mx-auto">
                <form method="post" action="{{url('admin/ad-update/'.$ads->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="grid grid-flow-col justify-items-center">
                        <div>
                            <h1 class="font-medium ">Previous Image: </h1>
                            <img src="/image/pic_ads/{{$ads->ads_img}}"
