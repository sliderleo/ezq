...
<body>
    <div class="rounded-lg shadow bg-base-200 drawer drawer-mobile">
        ...
        <h1 class="font-medium text-xl banner-text">&nbsp;Banned Vendors</h1>    
          ...
          <tbody>
              @foreach ($vendor as $item)
                  <tr>
                      ...
                      @endif
                      <td><a  class="btn btn-success" href="{{url('admin/vendor-unban/'.$item->id)}}">UNBAN</a></td>
                  </tr>
              @endforeach
          </tbody>
      </table>
