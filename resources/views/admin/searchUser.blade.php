...
<body>
    <div class="rounded-lg shadow bg-base-200  drawer drawer-mobile">
        ...
        <div class="flex flex-col drawer-con drawer-content">
            ...
            <h1 class="font-medium text-xl banner-text">&nbsp;Search User</h1> 
            <div class="container">
                <form method="post" action="{{url('/admin/user-search')}}" enctype="multipart/form-data" role="search">
                    @csrf
                            ...
                            <tbody>
                                @foreach ($user as $item)
                                    <tr>
                                        ...
                                        @endif
                                        <td><a  class="btn btn-error" href="{{url('admin/user-ban/'.$item->id)}}">Ban</a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
