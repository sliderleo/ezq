...
<body>
    <div class="rounded-lg shadow bg-base-200 drawer drawer-mobile">
        ...
        <h1 class="font-medium text-xl banner-text">&nbsp;Banned Store</h1>    
          ...
          <tbody>
              @foreach ($store as $item)
                  <tr>
                      ...
                      @endif
                      <td><a  class="btn btn-success" href="{{url('admin/store-unban/'.$item->id)}}">Unban</a></td>
                  </tr>
              @endforeach
          </tbody>
      </table>
