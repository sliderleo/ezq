...
<body>
    <div class="rounded-lg shadow bg-base-200 drawer drawer-mobile">
        ...
        <div class="flex flex-col drawer-con drawer-content">
            ...
            <h1 class="font-medium text-xl banner-text">&nbsp;Vendors</h1> 
            <div class="container mx-auto">
                <div class="grid grid-flow-col grid-cols-3 gap-9 justify-items-center">
                    <a href="{{ route('admin.vendorV')}}">
                        <div class="card shadow-lg bg-base-100 hover:bg-base-300">
                            <div class="card-body ">
                                <img class="card-img " src="..\..\..\image\icon\vendor.png"/>
                                <h2 class="card-title">All Vendors</h2> 
                            </div>
                        </div> 
                    </a>
                    <a href="{{ route('admin.searchVendor')}}">
                        <div class="card shadow-lg bg-base-100 hover:bg-base-300 justify-self-center">
                            <div class="card-body">
                                <img class="card-img" src="..\..\..\image\icon\search.png"/>
                                <h2 class="card-title">Search Vendor</h2> 
                            </div>
                        </div> 
                    </a>
                    <a href="{{ route('admin.vendorB')}}">
                        <div class="card shadow-lg bg-base-100 hover:bg-base-300 justify-self-center">
                            <div class="card-body">
                                <img class="card-img" src="..\..\..\image\icon\vendorBanned.png"/>
                                <h2 class="card-title">Banned Vendors</h2> 
                            </div>
                        </div> 
                    </a>
                </div>
